...
const snapshot:RoomSnapshot={
 ...
 members:[{principal_id:alex,display_name:'Alex',kind:'human',role:'manager',responsibilities:'Own the launch'},{principal_id:agent,display_name:"Alex's Agent",kind:'agent',role:'worker_agent',responsibilities:'Research and synthesis'}],
