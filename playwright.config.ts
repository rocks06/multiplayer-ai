...
export default defineConfig({
 testDir:'./tests/e2e',testMatch:['room-ui.playwright.ts','artifact-stabilization.playwright.ts','mentions-unread.playwright.ts','sign-out.playwright.ts'],fullyParallel:false,workers:1,timeout:45_000,
